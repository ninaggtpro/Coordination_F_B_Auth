...
export class AccountsController {
  ...
  @ApiResponse({
    status: 403,
    description:
      "Il est nécessaire de disposer d'un compte admin pour créer un compte",
  })
  @ApiResponse({
    status: 422,
    description:
      'Paramètre de connexion invalide: admin token manquant et / ou incorrect',
  })
  async create(
  ...
  @ApiOperation({
    ...
    description:
      "Retourne les informations détaillées d'un compte utilisateur.",
  })
  @ApiParam({
    name: 'id',
